...
## Next steps
For a better understanding of the language it is recommended to go through the documentation page-by-page. Or if you'd like to try it out yourself, see [Getting Started](getting_started.md).
